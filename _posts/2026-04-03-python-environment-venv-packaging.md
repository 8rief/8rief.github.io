...
> **配套实验代码**：完整源码和运行脚本见 [`assets/labs/python-local-evidence-kit/README.md`](/assets/labs/python-local-evidence-kit/README.md)。如果你还没有克隆本站仓库，先看[实验代码使用说明](/assets/labs/README.md)。
