...
- [RAII 和资源生命周期：让 C++ 对象负责释放资源](/computer-science-teaching/2026/04/27/cpp-raii-resource-lifetime.html)
- [unique_ptr、shared_ptr 和 raw pointer：把所有权写进类型](/computer-science-teaching/2026/04/27/cpp-ownership-smart-pointers.html)
- [GoogleTest 和可复现实验：让 C++ 测试能被定位、复跑和审计](/computer-science-teaching/2026/04/08/cpp-googletest-reproducible-tests.html)
